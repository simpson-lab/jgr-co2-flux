                     ...
                     if (!is.null(data$x)) {
                       if (grepl("b", sides)) {
                         rugs$x_b <- segmentsGrob(
                           ...
                           y0 = unit(0, "npc"), y1 = unit(0+data$rug_len, "npc"),
                           gp = gp
                         )
                       }
                       ...
                       if (grepl("t", sides)) {
                         rugs$x_t <- segmentsGrob(
                           x0 = unit(data$x, "native"), x1 = unit(data$x, "native"),
                           y0 = unit(1, "npc"), y1 = unit(1-data$rug_len, "npc"),
                           gp = gp
                         )
                       }
                     }
                     ...
                     if (!is.null(data$y)) {
                       if (grepl("l", sides)) {
                         rugs$y_l <- segmentsGrob(
                           ...
                           x0 = unit(0, "npc"), x1 = unit(0+data$rug_len, "npc"),
                           gp = gp
                         )
                       }
                       ...
                       if (grepl("r", sides)) {
                         rugs$y_r <- segmentsGrob(
                           y0 = unit(data$y, "native"), y1 = unit(data$y, "native"),
                           x0 = unit(1, "npc"), x1 = unit(1-data$rug_len, "npc"),
                           gp = gp
                         )
                       }
                     }
