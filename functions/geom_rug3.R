...
geom_rug3 <- function(mapping = NULL, data = NULL,
...
#' @usage NULL
#' @export
GeomRug3 <- ggproto("GeomRug3", Geom,
                      ...
                      if (!is.null(data$x)) {
                        if (grepl("b", sides)) {
                          rugs$x_b <- segmentsGrob(
                            ...
                            y0 = unit(0, "npc"), y1 = unit(0.01, "npc"),
                            gp = gp
                          )
                        }
                        ...
                        if (grepl("t", sides)) {
                          rugs$x_t <- segmentsGrob(
                            x0 = unit(data$x, "native"), x1 = unit(data$x, "native"),
                            y0 = unit(1, "npc"), y1 = unit(0.99, "npc"),
                            gp = gp
                          )
                        }
                      }
                      ...
                      if (!is.null(data$y)) {
                        if (grepl("l", sides)) {
                          rugs$y_l <- segmentsGrob(
                            ...
                            x0 = unit(0, "npc"), x1 = unit(0.01, "npc"),
                            gp = gp
                          )
                        }
                        ...
                        if (grepl("r", sides)) {
                          rugs$y_r <- segmentsGrob(
                            y0 = unit(data$y, "native"), y1 = unit(data$y, "native"),
                            x0 = unit(1, "npc"), x1 = unit(0.99, "npc"),
                            gp = gp
                          )
                        }
                      }
...
environment(geom_rug3) <- environment(ggplot)
